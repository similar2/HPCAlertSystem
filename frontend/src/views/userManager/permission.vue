    ...
    <el-dialog title="新建权限" v-model="showCreateDialog" width="400px">
      <el-form :model="newPermission">
        <el-form-item label="菜单代码">
          <el-input v-model="newPermission.menuCode" placeholder="输入菜单代码"></el-input>
        </el-form-item>
        <el-form-item label="菜单名称">
          <el-input v-model="newPermission.menuName" placeholder="输入菜单名称"></el-input>
        </el-form-item>
        <el-form-item label="权限代码">
          <el-input v-model="newPermission.permissionCode" placeholder="输入权限代码"></el-input>
        </el-form-item>
  ...
  methods: {
    ...
    submitCreatePermission() {
      if (!this.newPermission.menuCode || !this.newPermission.permissionCode ||
          ...
          !this.newPermission.requiredPermission) {
